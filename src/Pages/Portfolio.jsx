...
return(<>
 ...
 <div className="container  w-7xl">
  ...
  <div className="sticky top-[50px] bg-bgport lg:rounded-2xl rounded-t-2xl text-white lg:flex lg:flex-col items-center justify-center lg:py-12 py-8">
    ...
    <div  className="lg:w-3/4   flex-auto rounded-2xl ">
              <div  className={`gap-[38px]  text-white lg:flex absolute lg:right-16 right-4 lg:top-[64px] top-[60px] rounded-bl-xl lg:rounded-tr-2xl rounded-tl-2xl bg-[#2e2929] w-2/4 lg:h-[62px] h-[282px] px-10 py-4 transition-all duration-300 ${
          isClose ? "right-0 opacity-0" : "left-100 opacity-100"

        }`} >
                <div ><Link to="/" class="font-bold">Home</Link></div>
                <div className="pt-5 lg:pt-0"> <Link to="/" class="font-bold">Service</Link></div>
                <div className="pt-5 lg:pt-0"><Link to="/Portfolio" class="text-purple font-bold">Portfolio</Link></div>
                <div className="pt-5 lg:pt-0"><Link to="/" class="font-bold">About Us</Link></div>
                <div className="pt-5 lg:pt-0"><Link to="/" class="font-bold">Blog</Link></div>
                <div className="pt-5 lg:pt-0"><Link to="/" class="font-bold">Contact Us</Link></div>
  </div>
  <div className="bg-bgport lg:rounded-2xl rounded-b-2xl ">
  <button className="absolute lg:right-24 right-10   top-20" onClick={() => setIsClose(!isClose)}><img
  ...
  <div className="lg:mt-16 mt-10 lg:mx-8 mx-2 w-1/7"> 
  ...
  <div className="bg-[#2e2929] w-5 h-5 flex items-center justify-center rounded-xl ml-[11px] "><div className="text-white text-[80px] lg:mb-[60px] mb-[60px]">.</div></div>
  <div className="lg:h-24 h-[118px] xs:h-[139px] xss:h-[136px] w-[1px] bg-white ml-5 "></div>
  ...
  <div className="lg:h-24 h-[115px] xss:h-[138px] w-[1px] bg-white ml-5 "></div>
  <div className="bg-[#2e2929] w-5 h-5 flex items-center justify-center rounded-xl ml-[11px] "><div className="text-white text-[80px] mb-[60px]">.</div></div>
  <div className="lg:h-24 h-[118px] xss:h-[160px] w-[1px] bg-white ml-5 "></div>
  <div className="bg-[#2e2929] w-10 h-10 flex items-center justify-center rounded-lg shadow-md shadow-black"><img src={Book} alt="#" /></div>
  <div className="h-4 w-[1px] bg-white ml-5 mt-1"></div>
  <div className="bg-[#2e2929] w-5 h-5 flex items-center justify-center rounded-xl ml-[11px] "><div className="text-white text-[80px] mb-[60px]">.</div></div>
  <div className="lg:h-52 h-[325px] xs:h-[345px] xss:h-[407px] w-[1px] bg-white ml-5 "></div>
  <div className="bg-[#2e2929] w-10 h-10 flex items-center justify-center rounded-lg shadow-md shadow-black"><img src={Book} alt="#" /></div>
  <div className="h-6 w-[1px] bg-white ml-5 "></div>
  <div className="bg-[#2e2929] w-5 h-5 flex items-center justify-center rounded-xl ml-[11px] "><div className="text-white text-[80px] mb-[60px]">.</div></div>
  <div className="lg:h-36 h-[268px] xss:h-[325px] w-[1px] bg-white ml-5 "></div>
  <div className="bg-[#2e2929] w-5 h-5 flex items-center justify-center rounded-xl ml-[11px] "><div className="text-white text-[80px] mb-[60px]">.</div></div>
  <div className="lg:h-24 h-[130px] xs:h-[153px] xss:h-[155px] w-[1px] bg-white ml-5 "></div>
  <div className="bg-[#2e2929] w-10 h-10  flex items-center justify-center rounded-lg shadow-md shadow-black"><img src={Book} alt="#" /></div>
  <div className="h-32 w-[1px] bg-white ml-5 mb-10 "></div>
  </div>
  <div>
  <h3 className="w-2/7 lg:mt-[70px] mt-12 text-xl font-bold text-white">EDUCATION</h3>
  ...
  <p className="lg:w-[70%] w-[90%] text-white mt-2 text-sm">I am a proficient Frontend Developer with expertise in HTML, CSS, and JavaScript, complemented by advanced proficiency in frameworks such as React, Tailwind, and Bootstrap. My ability to design intuitive, visually engaging, and responsive user interfaces, combined with my knowledge of WordPress, allows me to drive impactful digital experiences. Committed to continuous learning and staying at the forefront of emerging technologies, I strive to deliver high-quality, innovative solutions that enhance user engagement and business success.</p>
